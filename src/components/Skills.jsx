...
const skills = [ "JavaScript (Node.js)", "Playwright", "Nightwatch.js", "Cucumber BDD", "Percy", "Ruby on Rails", "Claude Code", "MCP (Model Context Protocol)", "GitHub Copilot", "Cursor", "Java", "Basic SQL", "Basic Python", "TestNG", "Apache JMeter", "API Testing", "Spring Boot", "Spring Data JPA", "JUnit", "Apache Kafka", "Postman", "Maven", "JIRA", "Git", "GitHub", "Jenkins", "TeamCity", "HTML", "CSS", "MySQL", "Linux", "AWS", "Docker", "Ansible", "Splunk AppDynamics" ];
