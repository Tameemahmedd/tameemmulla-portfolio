      ...
      <div className="timeline-item">
        ...
        <div className="timeline-content">
          ...
          <ul>
            ...
            <li>Shipped product code in Ruby on Rails (2 merged PRs): production-guarded test endpoints that made ~14 background-job-only lifecycle emails automatable.</li>
